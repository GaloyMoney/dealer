...
export class DealerSimulatedWallet implements GaloyWallet {
  ...
  public async getWalletsBalances(): Promise<Result<WalletsBalances>> {
    const ret = await asyncRunInSpan(
      "app.dealerSimulatedWallet.getWalletsBalances",
      {
        [SemanticAttributes.CODE_FUNCTION]: "getWalletsBalances",
        [SemanticAttributes.CODE_NAMESPACE]: "app.dealerSimulatedWallet",
      },
      async () => {
  ...
  public async getWalletOnChainDepositAddress(): Promise<Result<string>> {
    const ret = await asyncRunInSpan(
      "app.dealerSimulatedWallet.getWalletOnChainDepositAddress",
      {
  ...
  public async getWalletOnChainTransactionFee(
    ...
    const ret = await asyncRunInSpan(
      "app.dealerSimulatedWallet.getWalletOnChainTransactionFee",
      {
  ...
  public async payOnChain(
    ...
    const ret = await asyncRunInSpan(
      "app.dealerSimulatedWallet.payOnChain",
      {
