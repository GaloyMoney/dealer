...
interface IPriceServiceService_IGetImmediateUsdPriceForBuy
  extends grpc.MethodDefinition<
    services_price_v1_price_service_pb.GetImmediateUsdPriceForBuyRequest,
    services_price_v1_price_service_pb.GetImmediateUsdPriceForBuyResponse
  > {
...
interface IPriceServiceService_IGetImmediateUsdPriceForSell
  extends grpc.MethodDefinition<
    services_price_v1_price_service_pb.GetImmediateUsdPriceForSellRequest,
...
interface IPriceServiceService_IGetImmediateUsdPriceForOptionBuy
  extends grpc.MethodDefinition<
...
interface IPriceServiceService_IGetImmediateUsdPriceForOptionSell
  extends grpc.MethodDefinition<
...
export interface IPriceServiceServer extends grpc.UntypedServiceImplementation {
  getImmediateUsdPriceForBuy: grpc.handleUnaryCall<
    services_price_v1_price_service_pb.GetImmediateUsdPriceForBuyRequest,
    services_price_v1_price_service_pb.GetImmediateUsdPriceForBuyResponse
  >
  getImmediateUsdPriceForSell: grpc.handleUnaryCall<
    services_price_v1_price_service_pb.GetImmediateUsdPriceForSellRequest,
    services_price_v1_price_service_pb.GetImmediateUsdPriceForSellResponse
  >
  getImmediateUsdPriceForOptionBuy: grpc.handleUnaryCall<
    services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionBuyRequest,
    services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionBuyResponse
  >
  getImmediateUsdPriceForOptionSell: grpc.handleUnaryCall<
    services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionSellRequest,
    services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionSellResponse
  >
}
...
export interface IPriceServiceClient {
  getImmediateUsdPriceForBuy(
    request: services_price_v1_price_service_pb.GetImmediateUsdPriceForBuyRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: services_price_v1_price_service_pb.GetImmediateUsdPriceForBuyResponse,
    ) => void,
  ...
  getImmediateUsdPriceForSell(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: services_price_v1_price_service_pb.GetImmediateUsdPriceForSellResponse,
    ) => void,
  ): grpc.ClientUnaryCall
  getImmediateUsdPriceForSell(
    request: services_price_v1_price_service_pb.GetImmediateUsdPriceForSellRequest,
  ...
  getImmediateUsdPriceForOptionBuy(
    request: services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionBuyRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionBuyResponse,
    ) => void,
  ): grpc.ClientUnaryCall
  getImmediateUsdPriceForOptionBuy(
    request: services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionBuyRequest,
  ...
  getImmediateUsdPriceForOptionSell(
    request: services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionSellRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionSellResponse,
    ) => void,
  ): grpc.ClientUnaryCall
  getImmediateUsdPriceForOptionSell(
    request: services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionSellRequest,
...
export class PriceServiceClient extends grpc.Client implements IPriceServiceClient {
  ...
  public getImmediateUsdPriceForBuy(
    request: services_price_v1_price_service_pb.GetImmediateUsdPriceForBuyRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: services_price_v1_price_service_pb.GetImmediateUsdPriceForBuyResponse,
  ...
  public getImmediateUsdPriceForOptionSell(
    request: services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionSellRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: services_price_v1_price_service_pb.GetImmediateUsdPriceForOptionSellResponse,
